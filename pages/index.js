...
export default function Home() {
  ...
  return (
    <Layout >
      ...
      <p className={styles.paragraph}> Currently, I{"'"}m a technical project manager for the Pay Equity project at <strong className={styles.strong} >KPMG Canada</strong>. I initially started my journey here last winter as an intern, where I started working on this project and other projects in the Web3 space.</p>
